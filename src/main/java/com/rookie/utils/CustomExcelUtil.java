...
import com.rookie.customize.poi.ExcelColumn;
import com.rookie.customize.poi.ExcelSheet;
import com.rookie.customize.poi.TrimXssEditor;
...
public class CustomExcelUtil {
    ...
    public static <T> void writeToResponse(List<T> list, Class<T> clazz, HttpServletResponse response) {
        try {
            ...
            throw new RookieRuntimeException(e, Internal.EXCEL_PROCESS_ERROR, e.getMessage());
        }
    }
